...
typedef struct IDispatchVtbl
{
    ...
    (IDispatch *This, DISPID dispIdMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS *pDispParams,
...
extern HRESULT STDCALL VariantChangeType(VARIANTARG *pvargDest, VARIANTARG *pvarSrc, unsigned short wFlags, VARTYPE vt);
#endif
...
extern HRESULT dispatchGetMemberID(IDispatch *obj, BSTR name, LCID lcid, DISPID *dispid);
extern char *getExcepInfoMessage(EXCEPINFO *info);
extern void freeExcepInfo(EXCEPINFO *info);
extern HRESULT dispatchInvoke(IDispatch *obj, DISPID dispid, LCID lcid, BOOL isfunction, unsigned flags, int cargs,
