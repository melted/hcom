...
Command line: -fno-qualified-names -fhs-to-c -fno-export-lists --gen-headers -fout-pointers-are-not-refs --gen-headers
-c SafeArray.idl
*/
...
extern HRESULT __stdcall SafeArrayAccessData(/*[in, ptr]*/ SAFEARRAY *psa, /*[out, ref]*/ void **ppvData);
extern HRESULT __stdcall SafeArrayAllocData(/*[in, ptr]*/ SAFEARRAY *psa);
extern HRESULT __stdcall SafeArrayAllocDescriptor(/*[in]*/ unsigned long cDims, /*[out]*/ SAFEARRAY **ppsaOut);
extern HRESULT __stdcall SafeArrayCopy(/*[in, ptr]*/ SAFEARRAY *psa, /*[out]*/ SAFEARRAY **ppsaOut);
/*[ref, finaliser("primSafeArrayDestroy"), finaliser("primSafeArrayDestroy"), ref, ref]*/
extern SAFEARRAY *__stdcall SafeArrayCreate(/*[in]*/ unsigned short vt, /*[in]*/ unsigned long cDims,
...
extern HRESULT __stdcall SafeArrayGetElement(/*[in, ptr]*/ SAFEARRAY *psa, /*[in, ptr]*/ long *rgIndices,
                                             /*[in, ptr]*/ void *pv);
extern unsigned long __stdcall SafeArrayGetElemsize(/*[in, ptr]*/ SAFEARRAY *psa);
extern HRESULT __stdcall SafeArrayGetLBound(/*[in, ptr]*/ SAFEARRAY *psa, /*[in]*/ unsigned long nDim,
                                            /*[out]*/ long *plLbound);
extern HRESULT __stdcall SafeArrayGetUBound(/*[in, ptr]*/ SAFEARRAY *psa, /*[in]*/ unsigned long nDim,
                                            /*[out]*/ long *plLbound);
extern HRESULT __stdcall SafeArrayLock(/*[in, ptr]*/ SAFEARRAY *psa);
extern HRESULT __stdcall SafeArrayPtrOfIndex(/*[in, ptr]*/ SAFEARRAY *psa, /*[in, ptr]*/ long *rgIndices,
                                             /*[out]*/ void **ppvData);
extern HRESULT __stdcall SafeArrayPutElement(/*[in, ptr]*/ SAFEARRAY *psa, /*[in, ptr]*/ long *rgIndices,
                                             /*[in, ptr]*/ void *pv);
extern HRESULT __stdcall SafeArrayRedim(/*[in, ptr]*/ SAFEARRAY *psa, /*[in, ref]*/ SAFEARRAYBOUND *psaboundNew);
