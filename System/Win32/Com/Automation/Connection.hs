...
-- Command line: -fno-qualified-names -fappend-interface-short-name -c System/Win32/Com/Automation/Connection.idl -o System/Win32/Com/Automation/Connection.hs

module System.Win32.Com.Automation.Connection
       ( DWORD
       , ULONG
       , PCONNECTIONPOINT
       , LPCONNECTIONPOINT
...
import System.Win32.Com (IUnknown, IID, mkIID, sizeofIID, 
                         ...
                         enumClone)
import System.Win32.Com.HDirect.HDirect (allocBytes, 
                                         sizeofForeignPtr, free, doThenFree, sizeofWord32, 
                                         readWord32, writeWord32, addNCastPtr)
...
unadvise dwCookie iptr =
  invokeAndCheck (\ methPtr iptr -> prim_System_Win32_Com_Automation_Connection_unadvise methPtr iptr dwCookie)
                 6
                 iptr
